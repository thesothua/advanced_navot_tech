            ...
            <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('customer_name') is-invalid @enderror" id="customer_name"
                        name="customer_name" value="{{ old('customer_name', $customer->customer_name) }}" required>
                    @error('customer_name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('contact_source') is-invalid @enderror" id="contact_source"
                        name="contact_source" value="{{ old('contact_source', $customer->contact_source) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                        name="description" rows="3">{{ old('description', $customer->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <!-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('address.street') is-invalid @enderror" id="address_street"
                        name="address[street]" value="{{ old('address.street', $customer->address['street'] ?? '') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" 
                           ...
                           id="address_city" 
                           name="address[city]" 
                           value="{{ old('address.city', $customer->address['city'] ?? '') }}">
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" 
                           ...
                           id="address_state" 
                           name="address[state]" 
                           value="{{ old('address.state', $customer->address['state'] ?? '') }}">
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" 
                           ...
                           id="address_zip" 
                           name="address[zip]" 
                           value="{{ old('address.zip', $customer->address['zip'] ?? '') }}">
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('address.country', $customer->address['country'] ?? '') }}">
                </div>
            </div>
        </div>
    </div>
