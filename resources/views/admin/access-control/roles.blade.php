...
@section('content')
            ...
            <div class="modal-content">
                <form id="editRoleForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Permissions</label>
                            <div class="row" id="edit-permissions-list">
                                @foreach ($permissions as $permission)
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input edit-permission-check" type="checkbox"
                                                value="{{ $permission->id }}" id="edit_perm_{{ $permission->id }}"
                                                name="permissions[]">
    ...
    <script>
        function editRole(id, name) {
            // Set form action & role name
            document.getElementById('edit_name').value = name;
            document.getElementById('editRoleForm').action = `/admin/access-control/roles/${id}`;

            // Clear checkboxes
            document.querySelectorAll('.edit-permission-check').forEach(cb => cb.checked = false);

            // Fetch role permissions
            fetch(`/admin/access-control/roles/${id}/permissions`, {
                    headers: {
